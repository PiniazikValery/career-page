    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="59.396" height="59.397" viewBox="0 0 59.396 59.397">
            <g id="Иконка" transform="translate(-625.302 -1530.302)">
                ...
                <g id="baseline-check-24px" transform="translate(643 1548)">
                    <path id="Path_393" data-name="Path 393" d="M0,0H24V24H0Z" fill="none" />
                    <path id="Path_394" data-name="Path 394" d="M9,16.17,4.83,12,3.41,13.41,9,19,21,7,19.59,5.59Z" fill="#4654aa" />
                </g>
            </g>
        </svg>
    );
