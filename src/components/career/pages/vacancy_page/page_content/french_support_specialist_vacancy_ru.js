export default {
    name: "Специалист поддержки со знанием французского языка (дистанционно)",
    salary: "от 1000 EUR",
    ...
    listBlocks: [
        {
            ...
            options: [
                'знание французского языка на уровне носителя (не ниже С1)',
                'законченное высшее образование (не студент)',
        ...
        },
        {
            ...
            options: [
                'общение с клиентами на французском языке (в чате, по почте/телефону) — консультирование по продукту, помощь, прием пожеланий/замечаний относительно работы с сайтом',
