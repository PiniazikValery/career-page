export default {
    name: "Специалист поддержки со знанием испанского языка (дистанционно)",
    salary: "от 1000 EUR",
    ...
    listBlocks: [
        {
            ...
            options: [
                'знание испанского языка на уровне носителя (не ниже С1)',
        ...
        },
        {
            ...
            options: [
                'общение с клиентами на испанском языке (в чате, по почте/телефону) — консультирование по продукту, помощь, прием пожеланий/замечаний относительно работы с сайтом',
