export default {
    name: "Специалист поддержки со знанием финского языка (дистанционно)",
    salary: "от 1000 EUR",
    ...
    listBlocks: [
        {
            ...
            options: [
                'знание финского языка на уровне носителя (не ниже С1)',
        ...
        },
        {
            ...
            options: [
                'общение с клиентами на финском языке (в чате, по почте/телефону) — консультирование по продукту, помощь, прием пожеланий/замечаний относительно работы с сайтом',
